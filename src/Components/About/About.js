        ...
        <div className="vision">
            ...
            <div className="container" style={{ paddingTop: "30px", color: "#393939" }}>
                ...
                <div className="vision-text" style={{ opacity: .6 }}>
                    ...
                    <p className="abt-paragraph" style={{ marginTop: "50px" }}>Our vision is to make Tinkering Lab the fountainhead of plethora of technological advancements. With a zeal to work on cutting-edge technologies, we aim to provide world-class services to build the most jaw-dropping projects. To move forward on this path, we have all the different machines and equipments which need to be used. This motivates us towards our end goal and we use this self motivation as a weapon to get further in life and convert our dreams into reality. Our end goal is to make Tinkering Lab a source of pride for the nation.</p>
                    <p className="abt-paragraph" style={{ marginTop: "15px" }}>With the growing demands of the economy in the innovative development, the Government of India has launched a mission to create ecosystems that promotes futuristic skills like complex problem solving, critical thinking, adaptive learning and computational skills in children.</p>
                    <p className="abt-paragraph" style={{ marginTop: "15px", marginBottom: "50px" }}>In the context of education, the Tinkering Lab refers to space where the youngsters can experiment with, learn, develop and conceptualize different scientific ideas. It is a lot similar to DIY(Do-it-yourself) method where the students are encouraged to apply the knowledge that they have gained in the classroom.</p>
                </div>
                <h1 className="headings" style={{ textAlign: "initial" }}>Mission</h1>
                <div className="vision-text" style={{ opacity: .6 }}>
                    <div className="line"></div>
                    <p className="abt-paragraph" style={{ marginTop: "50px" }}>Tinkering Lab is designed to help and nurture innovation amongst young innovators. The scheme enables students to explore new ideas, test them and follow ‘learning by doing’ approach. Students are introduced to different levels of tinkering, that includes experience design thinking and ideation to develop new perspectives towards social and community problems</p>
                    <p className="abt-paragraph" style={{ marginTop: "15px" }}>Young children are offered with opportunities to work with tools and equipment to understand the concepts of STEM (Science, Technology, Engineering and Math).</p>
                    <p className="abt-paragraph" style={{ marginTop: "15px", marginBottom: "60px" }}>To stimulate inventiveness among students, Tinkering Lab conducts different activities that range from regional and national level competitions, exhibitions, workshops on problem-solving, designing and fabrication of products, lecture series etc. at periodic intervals.</p>
                </div>
                <div className="team">
                    <h1 className="headings" style={{ textAlign: "initial" }}>Team</h1>
